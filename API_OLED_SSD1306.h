 ...
 * modification for STM32f10x: Alexander Lutsai<s.lyra@ya.ru>
   ...
   ----------------------------------------------------------------------
 */
#ifndef API_OLED_SSD1306_H
#define API_OLED_SSD1306_H 100
...
/**
 * @brief  Sets cursor pointer centered according to desired message copied to buffer
 * @param  buffer: Message to display
 * @param  line: Y Line location. This parameter can be a value between 0 and 1
 * @retval None
 */
void SSD1306_CenterXY(char * buffer, uint16_t line);
